 ...
 <style type="text/css" media="screen">
   ...
   window.onclick = function(event) {
	    ...
	    <div class="camera_wrap camera_emboss" id="camera_wrap">
		   ...
		   <center><h1>E Bank</h1><h3>Manages the assets of clients.</h3><br></center>						
		   </div></div>
		   <div data-thumb="investment_files/fish.jpg" data-src="investment_files/fish.jpg">
		   <div class="camera_caption fadeFromBottom">
		   <center><h1> Specialist in Bank Transactions</h1><h3>Provides specialist and  advisory services to High Net Worth Individuals.</h3><br></center>						
		   </div></div>
		   <div data-thumb="investment_files/volcane.jpg" data-src="investment_files/volcane.jpg">
		   <div class="camera_caption fadeFromBottom">
		   <center><h1>For further Information Contact us: </h1><h3>info@ebank.com</h3><br></center>						
		   </div></div>	   
	    </div>  <!-- #camera_wrap -->    
			    <footer id="footer-main">	
					<div id="copyright">
						  © 2017 EBank.  All Rights Reserved. 					
					</div><!-- #copyright -->			
			    </footer><!-- #footer-main -->  
